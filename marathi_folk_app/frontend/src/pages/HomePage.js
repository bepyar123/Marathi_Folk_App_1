...
// import CulturalPlatformFooter from "../components/CulturalPlatformFooter"; // Adjust path according to your folder
...
// import { Link } from "react-router-dom";
// import { motion } from "framer-motion";
// import CulturalPlatformFooter from "../components/CulturalPlatformFooter"; // Adjust path if needed
...
//       {/* Hero Section */}
//       <section className="flex flex-col md:flex-row justify-between items-center px-6 md:px-16 py-12 flex-1 mt-[130px]">
//         <div className="flex-1 space-y-6 text-center md:text-left">
//           <p className="text-[#d32f2f] font-semibold text-base md:text-lg">{text.aiTag}</p>
//           <h1 className="text-5xl md:text-6xl font-extrabold text-gray-800 leading-tight">
//             {text.heading}
