...
//   return (
//     <footer className="bg-[#d4183d] text-white pt-8 pb-4">
...
//             {/* <h4 className="text-lg font-semibold mb-3">Follow Our Journey</h4>
//             <div className="flex space-x-4 text-2xl">
//               <a href="#" className="hover:text-amber-300 transition duration-150">📘</a>
//               <a href="#" className="hover:text-amber-300 transition duration-150">📸</a>
//               <a href="#" className="hover:text-amber-300 transition duration-150">🐦</a>
//               <a href="#" className="hover:text-amber-300 transition duration-150">💼</a>
//             </div> */}
